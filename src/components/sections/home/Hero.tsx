...
export default function Hero() {
  ...
  const handleSecondaryAction = () => {
    setIsModalOpen(true); // Open SAP integration demo video
  };

  const handleBadgeAction = () => {
    router.push('/'); // Navigate to latest SAP updates
  };
        ...
        <div className="relative pt-20 pb-16 sm:pt-24 sm:pb-20 lg:pt-32 lg:pb-28">
          ...
          <div className="flex justify-center mb-8">
            ...
            >
              ...
              New: SAP S/4HANA Cloud Migration Solutions
          ...
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-8 leading-relaxed">
              Streamline operations, boost efficiency, and accelerate growth with our expert SAP ERP
              integration services. From implementation to optimization, we deliver enterprise
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-8 text-sm text-muted-foreground">
              ...
              <div className="flex items-center gap-1">
                ...
                <span className="ml-2">98% client satisfaction</span>
              </div>
            </div>
          </div>
              ...
              <div className="rounded-2xl border bg-card p-2 shadow-2xl">
                <div className="rounded-xl bg-gradient-to-br from-muted/50 to-muted aspect-video flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <p className="text-muted-foreground font-medium">SAP Integration Dashboard</p>
                    <p className="text-sm text-muted-foreground/80 mt-1">
                      Real-time ERP monitoring & analytics
                    </p>
                  </div>
                </div>
              </div>
