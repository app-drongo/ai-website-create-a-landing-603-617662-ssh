...
export default function Contact() {
  ...
  const contactMethods = [
    {
      ...
      description: 'SAP integration inquiries',
    ...
    },
    {
      icon: Phone,
      title: 'Direct Line',
      description: 'Speak with SAP consultants',
  ...
  const offices = [
    ...
    {
      city: 'Chicago',
      address: '1247 Enterprise Boulevard, Suite 2800',
      timezone: 'CST (UTC-6)',
    },
    {
      city: 'Singapore',
      address: '88 Business Hub Tower, Level 42',
      timezone: 'SGT (UTC+8)',
    },
  ];
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-lg text-muted-foreground leading-relaxed">
            Connect with our certified SAP consultants to discuss your ERP integration needs. We
            deliver enterprise-grade solutions with proven ROI.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-7xl mx-auto">
          ...
          <Card className="border-border/50 shadow-lg">
            <CardHeader className="bg-gradient-to-r from-primary/5 to-primary/10">
              ...
              <CardDescription>
                Get a personalized assessment of your SAP integration requirements within 24 hours.
              </CardDescription>
            </CardHeader>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="Describe your current SAP landscape, integration challenges, and business objectives. Include number of users, modules needed, and timeline expectations..."
                  />
                </div>
              ...
              <CardContent className="p-6">
                ...
                <div className="mt-4 p-3 bg-primary/10 rounded-lg border border-primary/20">
                  <p className="text-sm text-primary font-medium flex items-center gap-2">
                    ...
                    24/7 critical system support for Fortune 500 clients
                  </p>
                </div>
              </CardContent>
            </Card>
