...
export default function Cta() {
  ...
  const handlePrimaryAction = () => {
    router.push('/'); // Start SAP integration consultation
  };
  const handleSecondaryAction = () => {
    router.push('/'); // Schedule SAP assessment demo
  };
  // ACTION_PLACEHOLDER_END

  const stats = [
    { value: '500+', label: 'SAP Implementations', icon: Users },
    { value: '99.8%', label: 'Project Success Rate', icon: Shield },
    { value: '50+', label: 'SAP Modules Integrated', icon: Zap },
    { value: '24/7', label: 'SAP Support', icon: Sparkles },
  ];
            ...
            <div className="text-center max-w-4xl mx-auto">
              ...
              <h2 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold mb-6 leading-tight">
                ...
                <span className="block bg-gradient-to-r from-primary to-primary/60 bg-clip-text text-transparent">
                  Expert SAP Integration
                </span>
              </h2>

              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Streamline operations, boost efficiency, and drive growth with our comprehensive SAP
                ERP integration services. Trusted by Fortune 500 companies for seamless digital
                transformation.
              </p>
              ...
              <div className="text-center mb-12">
                <p className="text-sm text-muted-foreground mb-6">
                  Certified SAP Gold Partner - Trusted by global enterprises
                </p>
                <div className="flex flex-wrap justify-center items-center gap-8 opacity-60">
                  {/* SAP Partner logos placeholders */}
                  {[...Array(5)].map((_, i) => (
                    <div
                      key={i}
        ...
        <div className="text-center mt-16">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="space-y-2">
              ...
              <h3 className="font-semibold">Free SAP Assessment</h3>
              <p className="text-sm text-muted-foreground">
                Comprehensive analysis of your current systems and integration needs
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                SAP Gold Partner with 15+ years of enterprise integration experience
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Accelerated SAP implementation with minimal business disruption
              </p>
            </div>
          </div>
        </div>
